...
public class CoursewareEbookRelatedProduct {
    ...
    private List<GuidedNavigation> guidedNavigation = new ArrayList<GuidedNavigation>();
    ...
    @JsonProperty("guidedNavigation")
    public List<GuidedNavigation> getGuidedNavigation() {
        return guidedNavigation;
    }

    @JsonProperty("guidedNavigation")
    public void setGuidedNavigation(List<GuidedNavigation> guidedNavigation) {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CoursewareEbookRelatedProduct) == false) {
            return false;
        }
        CoursewareEbookRelatedProduct rhs = ((CoursewareEbookRelatedProduct) other);
