...
public class Record {
    ...
    @JsonProperty("smpDescription")
    public Object getSmpDescription() {
        return smpDescription;
    }

    @JsonProperty("smpDescription")
    public void setSmpDescription(Object smpDescription) {
    ...
    @JsonProperty("cuEBookIsbns")
    public Object getCuEBookIsbns() {
        return cuEBookIsbns;
    }

    @JsonProperty("cuEBookIsbns")
    public void setCuEBookIsbns(Object cuEBookIsbns) {
